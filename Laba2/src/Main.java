...
public class Main {
    private static Logger logger = LogManager.getLogger(Main.class.getName());
        public static void main(String[] args) throws FileNotFoundException {
            ...
            if( resMenu == 1)
            {
                ...
                logger.info("Создался сканер консоли");
            }
            else
            {
                File F1 = new File("Dan.txt");
                scanner = new Scanner(F1);
                logger.info("Создался сканер файла");
            }
        ...
        private static void Task1(Scanner a, byte resMenu) {
            ...
            try {
                ...
                logger.fatal("Ошибка чтения данных в переменную x");
            }
        ...
        private static void Task2(Scanner a, byte resMenu) {
            ...
            {
                logger.fatal("Ошибка чтения данных в переменную а");
            }
        }
     ...
     * @param  resMenu - результат выполнения функции Menu(), задающий параметры отображения сообщений*/
        private static void Task8(Scanner a, byte resMenu)
        {
            ...
            {
                logger.fatal("Ошибка чтения данных в переменную kolGeo");
            }
        }

        private static byte Menu()
        {
            logger.info("Вызвалось меню");
